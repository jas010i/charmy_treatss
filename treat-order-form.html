...
<body>
    ...
    <header>
        ...
        <div class="input-form">
            ...
            <div id="treat-card">
            <img src="Images/treats_page/treats-strawberry-cheesecake-1.jpg" alt="Strawberry Cheesecake">
                <select id="cc_strawberry" name="cc_strawberry">
            ...
            <div id="treat-card">
                <img src="Images/treats_page/treats-chocolate-straberry-cake-1.jpeg" alt="Chocolate Cake with Strawberry Topping">
                    <select id="cake_chocStraw" name="cake_chocStraw">
                        <option value="null"></option>
                        <option value="1">1</option>
                        <option value="2">2</option>
                        <option value="3">3</option>
                ...
                <div id="treat-card">
                    <img src="Images/treats_page/treats-cake-pop-1.jpeg" alt="Cake Pop">
                        <select id="cakepop_1" name="cakepop_1">
                            <option value="null"></option>
                            <option value="1">1</option>
                            <option value="2">2</option>
                            <option value="3">3</option>
                    ...
                    <div id="treat-card">
                        <img src="Images/treats_page/treats-cake-pop-2.jpg" alt="Cake Pop">
                            <select id="cakepop_2" name="cakepop_2">
                                <option value="null"></option>
                                <option value="1">1</option>
                                <option value="2">2</option>
                                <option value="3">3</option>
                    ...
                    <div id="treat-card">
                        <img src="Images/treats_page/treats-oreo-bites.jpg" alt="Oreo Bites">
                            <select id="oreobites" name="oreobites">
                                <option value="null"></option>
                                <option value="1">1</option>
                                <option value="2">2</option>
                                <option value="3">3</option>
                    ...
                    <div id="treat-card">
                        <img src="Images/treats_page/treats-pie-1.jpeg" alt="Pie">
                            <select id="pie_1" name="pie_1">
                                <option value="null"></option>
                                <option value="1">1</option>
                                <option value="2">2</option>
                                <option value="3">3</option>
        ...
        <footer>
            ...
            <img src="Images/logo_web/background-footer.png">
            ...
            <div class="footer-list2">
                ...
                <p id="copyright">Published and Managed by Intrizik Designs.
                                    <br>
